namespace TestBalloonsPopsGame
{
    ...
    public class BalloonsContainerTest
    {
        ...
        {
            var container = this.ArrangeContainer(BalloonType.Red);
            Assert.IsTrue(this.ContainerContainsOnly(container, BalloonType.Red), "Filling with red ballons doesn't work!");
        }

        [TestMethod]
        public void TestFillingWithBlueBalloons()
        {
            var container = this.ArrangeContainer(BalloonType.Blue);
            Assert.IsTrue(this.ContainerContainsOnly(container, BalloonType.Blue), "Filling with blue ballons doesn't work!");
        }

        [TestMethod]
        public void TestFillingWithYellowBalloons()
        {
            var container = this.ArrangeContainer(BalloonType.Yellow);
            Assert.IsTrue(this.ContainerContainsOnly(container, BalloonType.Yellow), "Filling with yellow ballons doesn't work!");
        }

        [TestMethod]
        public void TestFillingWithGreenBalloons()
        {
            var container = this.ArrangeContainer(BalloonType.Green);
            Assert.IsTrue(this.ContainerContainsOnly(container, BalloonType.Green), "Filling with green ballons doesn't work!");
        }
        ...
        public void TestNormalFilling()
        {
            ...
            container.Fill();
            Assert.IsTrue(this.ContainerContainsOnly(container, BalloonType.Green, BalloonType.Blue, BalloonType.Red, BalloonType.Yellow), "Normal filling doesn't work!");
        }
        ...
        public void TestEmptying()
        {
            ...
            container.Fill();
            container.Empty();
            Assert.IsTrue(this.ContainerContainsOnly(container, BalloonType.Popped), "Container emptying doesn't work!");
        }
        ...
        public void TestGetEnumerator()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(result, container.Balloons), "GetEnumerator doesn't work correctly!");
        }
        ...
        public void TestPoppingSingleBalloonWithoutShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for single balloon popping without shifting!");
        }
        ...
        public void TestPoppingSingleBalloonWithShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for single balloon popping with shifting!");
        }
        ...
        public void TestPoppingMultipleHorizontalBalloonsWithoutShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for multiple horizontal balloons popping without shifting!");
        }
        ...
        public void TestPoppingMultipleHorizontalBalloonsWithShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for multiple horizontal balloons popping with shifting!");
        }
        ...
        public void TestPoppingMultipleVerticleBalloonsWithoutShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for multiple verticle balloons popping without shifting!");
        }
        ...
        public void TestPoppingMultipleVerticleBalloonsWithShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for multiple verticle balloons popping with shifting!");
        }
        ...
        public void TestMultipleBalloonsPoppingBothDirectionWithoutShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for multiple balloons popping both directions without shifting!");
        }
        ...
        public void TestMultipleBalloonsPoppingBothDirectionsWithShifting()
        {
            ...
            Assert.IsTrue(this.AreMatrixesEqual(expectedOutput, balloons), "Balloons popping doesn't work for multiple balloons popping both directions with shifting!");
        }
